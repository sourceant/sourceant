...
If inline posting fails, findings are posted in a new comment with file and line links. Large findings sets are split across numbered comments. Retries resume the same delivery and reuse comments already posted for it; a later review gets its own findings comment.
