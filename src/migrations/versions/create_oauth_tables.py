...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_user_repositories_github_repo_id'), 'user_repositories', ['github_repo_id'], unique=False)
    op.create_index(op.f('ix_user_repositories_id'), 'user_repositories', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_user_repositories_github_repo_id'), table_name='user_repositories')
