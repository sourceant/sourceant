...
class GitHubOAuthHandler:
    ...
    def generate_auth_url(self, state: Optional[str] = None, scope: str = "read:user,repo") -> Dict[str, str]:
        """
    ...
    async def exchange_code_for_token(self, code: str, code_verifier: str, state: str) -> Optional[Dict[str, Any]]:
        """
    ...
    async def create_or_update_user(self, user_info: Dict[str, Any], token_info: Dict[str, Any]) -> Optional[User]:
        """
    ...
    async def update_user_repositories(self, user: User, repositories: List[Dict[str, Any]]) -> int:
        """
        ...
        try:
            ...
            db.commit()
            logger.info(f"Updated {updated_count} repositories for user {user.username}")
